...
//   // Handle scroll effects and visibility
//   useEffect(() => {
//     const handleScroll = () => {
...
//       {/* Top Navigation Bar */}
//       <header className="w-full bg-white shadow-sm sticky top-0 z-10">
//         <div className="bg-gray-900 py-2 px-4 md:px-8">
//           <div className="flex justify-between items-center max-w-7xl mx-auto">
//             <div className="flex items-center">
//               <img src="/api/placeholder/120/30" alt="Envato Market" className="h-6" />
//             </div>
//             <button className="bg-green-500 hover:bg-green-600 transition-colors text-white px-4 py-1 rounded text-sm font-medium transform hover:scale-105 duration-200">
//               Buy now
//             </button>
//           </div>
//         </div>
...
//               </svg>
//             </div>
//             <div className="font-bold text-xl text-gray-800 hover:text-red-500 transition-colors duration-300">DENTATIZ</div>
//           </div>
...
//             </a>
//             <a href="#" className="text-indigo-600 font-medium transition-colors relative">
//               About Us
//               <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-indigo-400"></span>
//             </a>
//             <div className="relative group">
//               <a href="#" className="text-gray-500 hover:text-gray-700 transition-colors flex items-center relative">
//                 Services
...
//           <div>
//             <button className="bg-gray-900 text-white px-6 py-3 rounded-full font-medium hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
//               Contact Us
//             </button>
//           </div>
//         </div>
...
//       <main className="flex-grow">
//         {/* Hero Banner Section */}
//         <section className="py-16 px-4 md:px-8 max-w-6xl mx-auto transition-all duration-1000 transform">
//           <div className="mb-8">
//             <span className="inline-block px-3 py-1 bg-blue-100 text-blue-500  rounded-full text-sm font-medium">About Us</span>
//           </div>

//           <div className={`flex flex-col md:flex-row justify-between items-center gap-12 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//             <div className="md:w-1/2">
...
//                 <img 
//                   src="https://images.pexels.com/photos/3845761/pexels-photo-3845761.jpeg?auto=compress&cs=tinysrgb&w=1200" 
//                   alt="Dental consultation" 
//                   className="w-full rounded-lg object-cover h-96 transform transition-all duration-700 hover:scale-110" 
//                 />
//               </div>
//             </div>
            
//             <div className={`md:w-1/2 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
//               <p className="text-xl text-gray-600 mb-6">
//                 Dedicated to providing top-quality dental care with a patient-first approach.
//               </p>
...
//             <div className="flex flex-col md:flex-row items-center justify-between mb-16">
//               <div className={`md:w-1/2 mb-8 md:mb-0 transition-all duration-700 transform ${scrollY > 200 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//                 <div className="overflow-hidden rounded-lg shadow-lg">
//                   <img 
//                     src="https://images.pexels.com/photos/3845810/pexels-photo-3845810.jpeg?auto=compress&cs=tinysrgb&w=1200"
//                     alt="Dental team" 
//                     className="w-full rounded-lg transform transition-all duration-700 hover:scale-105" 
//                   />
//                 </div>
//                 <div className="bg-white shadow-lg p-4 rounded-lg mt-4 flex items-center justify-center transform hover:translate-y-1 transition-all duration-300">
//                   <div className="flex text-yellow-400">
...
//               <div className={`md:w-1/2 md:pl-12 transition-all duration-700 transform ${scrollY > 200 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
//                 <div className="mb-6">
//                   <span className="inline-block px-3 py-1 bg-blue-100 text-blue-500  rounded-full text-sm font-medium mb-2">Our Story</span>
//                   <h2 className="text-4xl font-bold text-gray-900 mb-4">Your Confident Smile</h2>
//                 </div>
...
//                     <div className="ml-4">
//                       <h3 className="text-xl font-bold text-gray-900">Our Vision</h3>
//                       <p className="text-gray-600">To be the trusted leader in dental care through excellence and innovation.</p>
//                     </div>
//                   </div>
...
//           <div className="max-w-6xl mx-auto">
//             <div className={`transition-all duration-1000 transform ${scrollY > 600 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//               <div className="text-center mb-12">
//                 <span className="inline-block px-3 py-1 bg-blue-100 text-blue-500  rounded-full text-sm font-medium mb-2">Our Team</span>
//                 <h2 className="text-3xl font-bold text-gray-900">Meet Our Professional</h2>
//                 <h2 className="text-3xl font-bold text-gray-900 mt-2">Certified Dentists</h2>
//               </div>
              
//               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//                 {/* Dentist 1 */}
//                 <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 hover:bg-gray-100">
...
//                   <div className="p-6">
//                     <h3 className="text-xl font-bold text-gray-900">Dr. Sarah Johnson</h3>
//                     <p className="text-red-500 font-medium">Orthodontist</p>
//                     <p className="text-gray-600 mt-2">10+ years of experience in orthodontic treatments and smile makeovers.</p>
//                     <div className="mt-4 flex space-x-3">
//                       <a href="#" className="text-indigo-600 hover:text-indigo-800 transition-colors relative group">
//                         View Profile
...
//                   <div className="overflow-hidden">
//                     <img 
//                      src="https://img.freepik.com/free-photo/doctor-standing-with-folder-stethoscope_1291-16.jpg"
//                       alt="Dentist 2" 
//                       className="w-full h-64 object-cover transition-transform duration-700 hover:scale-110" 
//                     />
//                   </div>
//                   <div className="p-6">
//                     <h3 className="text-xl font-bold text-gray-900">Dr. Michael Brown</h3>
//                     <p className="text-red-500 font-medium">Dental Surgeon</p>
//                     <p className="text-gray-600 mt-2">Specialized in complex dental surgeries and restorative procedures.</p>
//                     <div className="mt-4 flex space-x-3">
//                       <a href="#" className="text-indigo-600 hover:text-indigo-800 transition-colors relative group">
//                         View Profile
...
//                   <div className="overflow-hidden">
//                     <img 
//                       src="https://img.freepik.com/free-photo/portrait-smiling-young-woman-doctor-healthcare-medical-worker-pointing-fingers-left-showing-clinic-banner-standing-white-wall_1258-88432.jpg" 
//                       alt="Dentist 3" 
//                       className="w-full h-64 object-cover transition-transform duration-700 hover:scale-110" 
//                     />
//                   </div>
//                   <div className="p-6">
//                     <h3 className="text-xl font-bold text-gray-900">Dr. Emily Wilson</h3>
//                     <p className="text-red-500 font-medium">Cosmetic Dentist</p>
//                     <p className="text-gray-600 mt-2">Expert in cosmetic procedures and aesthetic dental solutions.</p>
//                     <div className="mt-4 flex space-x-3">
//                       <a href="#" className="text-indigo-600 hover:text-indigo-800 transition-colors relative group">
//                         View Profile
...
//           <div className="max-w-6xl mx-auto">
//             <div className={`transition-all duration-1000 transform ${scrollY > 1000 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//               <div className="mb-12 text-center">
//                 <span className="inline-block px-3 py-1 bg-blue-100 text-blue-500 rounded-full text-sm font-medium mb-2">Why Choose Us</span>
//                 <h2 className="text-4xl font-bold text-gray-900">Your Trusted Partner</h2>
//                 <h2 className="text-4xl font-bold text-gray-900 mt-2">In Dental Health Care</h2>
//               </div>
...
//                 <div className="md:w-1/2">
//                   <div className="relative pl-16 mb-12 group cursor-pointer">
//                     <div className="absolute left-0 top-0 bg-blue-100 text-blue-500  p-3 rounded-full transition-all duration-300 group-hover:bg-red-200 group-hover:scale-110">
//                       <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
//                         <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
//                       </svg>
//                     </div>
//                     <div className="transform transition-all duration-300 group-hover:translate-x-2">
//                       <h3 className="text-xl font-bold text-gray-900">Certified Dentists</h3>
//                       <p className="text-gray-600 mt-2">Experience expert dental care with certified specialists.</p>
//                     </div>
//                   </div>
...
//                     <div className="transform transition-all duration-300 group-hover:translate-x-2">
//                       <h3 className="text-xl font-bold text-gray-900">Modern Dental Tools</h3>
//                       <p className="text-gray-600 mt-2">Discover the difference that modern dental technology makes for your teeth.</p>
//                     </div>
//                   </div>
...
//                   <div className="overflow-hidden rounded-lg shadow-lg">
//                     <img 
//                       src="https://img.freepik.com/free-photo/dentist-examining-patient-teeth_23-2148985297.jpg" 
//                       alt="Dentist working" 
//                       className="w-full rounded-lg transform transition-all duration-700 hover:scale-110" 
//                     />
//                   </div>
//                 </div>
//               </div>
...
//             <div className="bg-indigo-600 rounded-lg px-6 py-12 shadow-xl">
//               <h2 className="text-3xl font-bold text-white mb-4">Ready for Your Healthiest Smile?</h2>
//               <p className="text-indigo-100 mb-8 max-w-2xl mx-auto">
//                 Schedule your consultation today and take the first step toward a lifetime of dental health and confidence.
//               </p>
//               <button className="bg-white text-indigo-600 px-8 py-3 rounded-full font-medium hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
//                 Book an Appointment
//               </button>
//             </div>
//           </div>
